/** Documentation of Materials Management: Business Claims Report
...
*/
--Returns a list of all items marked 'Claimed returned' across selected Business Library locations.
SELECT DISTINCT
	lsc.id AS loan_id,
...
WHERE lsc.jsonb ->> 'itemStatus' = 'Claimed returned'
	...
	AND lt2.code IN ('BUS','BUSRES','BUSPOP','BUSNB','BUSOV','BUSRES','BUSSER','BUSST')
