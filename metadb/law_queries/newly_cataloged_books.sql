...
where folio_inventory.instance__t.cataloged_date >= '2024-08-07' and folio_inventory.location__t."name" like '%Law%' and folio_inventory.location__t."name" != 'Law Electronic Resources' and folio_source_record.marc__t.field = '020'
;
