...
AS $$
select distinct on (folio_inventory.instance__t.hrid) folio_inventory.instance__t.hrid as hrid,
  ...
  where folio_inventory.instance__t.cataloged_date >= '2023-10-10'
