/** Documentation of Materials Management: Earth Sciences & Map Claims Returned
...
*/
--Returns a list of all items marked 'Claimed returned' across selected Earth Sciences Library locations.
SELECT DISTINCT
	lsc.id AS loan_id,
...
WHERE lsc.jsonb ->> 'itemStatus' = 'Claimed returned'
	...
	AND lt2.code IN ('ESC','ESCST','ESCOV','ESCREF','ESCRES','ESCTH')
