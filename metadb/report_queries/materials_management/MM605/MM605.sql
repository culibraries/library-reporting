...
Returns a list of all items marked 'Claimed returned' across Norlin Library and Pascal.
...
where i.jsonb -> 'status' ->> 'name' = 'Claimed returned'
	...
	AND l3.jsonb ->> 'code' in ('NOR','OFF')  --('NOR','OFF') --('BUS','MUS','ESC','ENG') --('NOR','BUS','MUS','OFF','ESC','ENG')
